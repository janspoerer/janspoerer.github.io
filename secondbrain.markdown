...
If you do would like to get a bit more advanced, I recommend the PARA method by [[Tiago Forte]]. Check [this link](https://fortelabs.co/blog/para/). PARA will, at the very minimum, require you to drag and drop each new note into one of four different folders. That's an acceptable effort.
