...
**What was the cost of the switch?** It took me about five hours to transfer about 70% of my literature database to Zotero. My literature database has 300 entries, and I left out some entries that I found to be no longer useful. So you can expect one or two full days of work for a database with a couple hundred entries.
